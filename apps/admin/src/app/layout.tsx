...
function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-gradient-to-b from-slate-950 via-slate-900 to-rose-950/30 hidden md:flex flex-col z-20 border-r border-rose-900/30">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-slate-800">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-rose-500 to-rose-700 flex items-center justify-center flex-shrink-0 shadow-md shadow-rose-500/40">
          ...
          <div>
            ...
            <p className="text-om-ink-soft text-xs mt-0.5">Admin Console</p>
          </div>
        </Link>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                isActive
                  ? "bg-rose-600/15 text-white border-l-2 border-rose-400 pl-[10px]"
      ...
      <div className="px-5 py-4 border-t border-slate-800 space-y-3">
        ...
        <p className="text-xs text-om-ink-soft">Moderator Session</p>
        <button
...
function MobileNav() {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 inset-x-0 bg-slate-950/95 backdrop-blur-lg border-t border-rose-900/30 flex z-20"
      role="navigation"
        ...
        return (
          <Link
            ...
            className={`flex-1 flex flex-col items-center justify-center py-3 gap-1 transition-colors ${
              isActive ? "text-rose-400" : "text-om-ink-soft hover:text-om-line"
            }`}
          >
            {link.icon}
