      ...
      {confirmReject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-om-surface rounded-2xl shadow-xl max-w-md w-full mx-4 p-6" role="dialog" aria-modal="true">
            <h2 className="text-lg font-semibold text-om-ink mb-2">Reject Release</h2>
            <p className="text-sm text-om-ink-soft mb-4">Provide a reason for rejection. The developer will be notified.</p>
            <textarea
              value={reason}
