...
import { Button, Input, Card, CardContent } from "@openmarket/ui";
      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          <CardContent className="pt-6">
            <h2 className="text-lg font-semibold text-om-ink mb-1">Create account</h2>
            ...
            <p className="mt-6 text-sm text-center text-om-ink-soft">
              ...
              <Link href="/login" className="text-om-primary hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </CardContent>
